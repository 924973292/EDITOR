...
_C.MODEL.PRETRAIN_PATH_R = '/15127306268/wyh/UIS/pth/res50.pth'
...
_C.MODEL.TRANSFORMER_TYPE = 'vit_base_patch16_224_Trans'
...
_C.DATASETS.ROOT_DIR = ('./data/dukemtmc')
